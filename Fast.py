#!/usr/bin/python2
#coding=utf-8
#THE OFFICAL FASI TRICKER
#FOLLOWS ON FACEBOOK fasi.53
#COPY KARNY SAY PEHLY BAAP KA NAAM YADD RAKHNA FASI
#CONTACT ON FACEBOOK
...
\033[1;96m╚═╝░░░░░╚═╝░░╚═╝╚═════╝░╚═╝                            
\033[1;96m❋❈╤─────────────────────────❤
\033[1;96m♚♚║\033[1;32mCREATOR  : \033[1;32mFASI TRICKER
\033[1;96m♚♚║\033[1;32mYOUTUBE : \033[1;32mhttps://www.youtube.com/channel/UC_yWy4lCYj3CMe8ZL6EDwfQ
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev : FASI TRICKER
            loop = 'false'
        else:
...
def pilih_super():
	...
	if peak =="":
		...
		print 42*"\033[1;96m="
		try:
			idlist = raw_input('\x1b[1;96m[+] \x1b[1;93mEnter Target link type👉(fasitricker.txt)\x1b[1;91m: \x1b[1;97m')
...
\033[1;95mCHECKPOINT ACCOUNT AFTER 7 DAYS
  \033[1;95mI M NOT RESPONSIBLE FOR ANY MISS USE 
\033[1;95m   ⚒️ FASI TRICKER
\033[1;98m ⚌⚌⚌⚍⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌⚌    """
